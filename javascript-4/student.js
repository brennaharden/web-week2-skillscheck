...
// CODE HERE
let faveColors = ['orange', 'green', 'purple']
//////////////////Step 2////////////////////
...
let me = {
    firstName: 'Brenna',
    superHeroName: 'Bananas Foster',
    homeTown: 'Denton, TX',
    superPowers: ['Super Strength', 'Parkour', 'Empathy'],
...
const setColor = (arr) => {
    arr.forEach(function(elem, index){
        index > 2 ? arr.splice(index, 1) : null
    })

    for(let i = 0; i < arr.length; i++){
        arr[i] === 'blue' ? arr[i] = '#4D4DFF' : null
    }
